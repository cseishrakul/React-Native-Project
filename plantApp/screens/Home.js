...
const Home = ({navigation}) => {
  ...
  function renderNewPlants(item, index){
    return(
      <View style={{
            alignItems:'center',justifyContent:'center',marginHorizontal:SIZES.base
        }}
      >
        <Image
          source={item.img}
  ...
  function renderFrinendsComponent(){
  ...
  return (<View style={styles.container}>
    ...
    <View style={{
      ...
      <View style={{
        ...
        <View
          style={{
            marginTop:SIZES.padding * 2,marginHorizontal:SIZES.padding
          }}
        >
          <View
            style={{
          ...
          >
            <Text style={{color:COLORS.white, ...FONTS.h2}}>New Plant's</Text>
            <TouchableOpacity
    ...
    <View style={{height: "50%",backgroundColor: COLORS.lightGray}}>
      ...
      >
        ...
        <View style={{flexDirection:'row',height:'88%',marginBottom:SIZES.base}}>
          <View style={{flex:1}}>
            <TouchableOpacity
              style={{
                flex:1,
