...
const PlantDetail = ({navigation}) => {
  ...
  function renderRequirements() {
    return (<View style={{
      ...
      <RequirementDetail icon={icons.seed} label="Fertilizer" detail="15°C"/>
    </View>)
  }
  ...
  function renderFooter() {
    return (<View style={{
      ...
      <View style={{
        ...
        <Text style={{color:COLORS.secondary,flex:1,...FONTS.h3}}>Alomost 2 weeks of growing time</Text>
        <Image
  ...
  return (<View style={styles.container}>
    ...
    <View style={{
      ...
      <Image source={images.bannerBg} resizeMode="cover" style={{
          width: '100%',
          height: '100%'
        }}/>
    </View>
